...
for (const ck in tests) {
    ...
    for (const tk in tests[ck]) {
        ...
        const propKey = (_b = ((_a = decl.options[tk].macroFor) !== null && _a !== void 0 ? _a : decl.options[tk].mapTo)) !== null && _b !== void 0 ? _b : tk;
        ...
        if (!didPass || VERBOSE_OUTPUT) {
            ...
            console.log('Output:       ', didParse ? res : '<no return value>');
